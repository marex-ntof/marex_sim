/**
 * @file MArEXPrimaryGeneratorAction.cxx
 * @author Nicholas Carrara [nmcarrara@ucdavis.edu]
 * @brief 
 * @version 0.1
 * @date 2022-12-13
 */
#include "MArEXPrimaryGeneratorAction.hh"

namespace marex
{
    MArEXPrimaryGeneratorAction::MArEXPrimaryGeneratorAction()
    ...
    MArEXPrimaryGeneratorAction::MArEXPrimaryGeneratorAction(YAML::Node config)
    : G4VUserPrimaryGeneratorAction()
    , mConfig(config)
    {
    ...
    G4double MArEXPrimaryGeneratorAction::SampleBeamEnergy()
    {
    ...
    G4double MArEXPrimaryGeneratorAction::SampleTOF(G4double beam_energy)
    {
        if(mUsenTOFTOF)
        {
    ...
    G4ThreeVector MArEXPrimaryGeneratorAction::SampleBeamProfile(
    ...
    G4ThreeVector MArEXPrimaryGeneratorAction::SampleBeamMomentum(
    ...
    void MArEXPrimaryGeneratorAction::GeneratePrimaries(G4Event* event)
    {
        mParticleGun->SetNumberOfParticles(1);
